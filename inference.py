...
def main():
    ...
    if data_args.eval_retrieval:
        ...
        if model_args.retrieval=='sparse':
            ...
            # with open("bm25_top20.pickle", "rb") as file:
                # sparse_datasets = pickle.load(file)
            # with open("dual_retrieval_top20_v2.pickle", "rb") as file:
                # dense_datasets = pickle.load(file)
            with open("retrieval.pickle", "rb") as file:
