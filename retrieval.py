...
class SparseRetrieval:
    def __init__(
        ...
        print(context_path)
        if mode=='inference':
            # print("/".join(data_path, context_path))
    ...
    def BM25(self, query_or_dataset, topk=20):
        # print(query_or_dataset)
        query_set = load_from_disk('../data/test_dataset')['validation']
        ...
        for idx, example in enumerate(
            tqdm(query_set, desc="Sparse retrieval: ")
        ):  
        ...
        with open('bm25_top20.pickle','wb') as fw:
    ...
    def get_sparse_embedding(self) -> NoReturn:
        ...
        # Pickle을 저장합니다.
        # pickle_name = f"new_sparse_embedding.bin"
        # tfidfv_name = f"new_tfidv.bin"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", default="inference", type=str, help="")
    parser.add_argument(
